        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Warmindo Barokah terbaik dengan desain modern dan rasa premium. Nikmati hidangan hangat di tempat yang sangat nyaman.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-secondary hover:text-text-main transition-colors duration-300">
          ...
          <div>
            ...
            <a 
              ...
              className="inline-flex items-center gap-3 bg-secondary text-text-main px-6 py-3.5 rounded-xl font-bold hover:bg-primary-hover hover:text-white hover:-translate-y-1 hover:shadow-lg hover:shadow-secondary/20 transition-all duration-300 w-full sm:w-auto justify-center"
            >
              <Phone size={18} />
              Pesan via WhatsApp
            </a>
