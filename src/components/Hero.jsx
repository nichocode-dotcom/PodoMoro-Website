  ...
  return (
    <section className="relative w-full min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-4 flex flex-col items-center justify-center text-center h-full py-20">
        ...
        >
          <span>⭐</span> 5.0 Rating • 30+ Menu Items
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-7xl leading-[1.1] text-white mb-6 font-bold font-heading max-w-4xl"
        >
        ...
        >
          Nikmati berbagai hidangan klasik warmindo, dibuat dari bahan berkualitas dan disajikan dalam suasana yang nyaman.
        </motion.p>
        ...
        >
          <a href="/menu" className="w-full sm:w-auto inline-block px-8 py-3.5 bg-primary text-white font-semibold rounded-md hover:bg-primary-hover hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/30 transition-all duration-200">
            Lihat Menu
          </a>
          <a href="/kontak" className="w-full sm:w-auto inline-block px-8 py-3.5 bg-transparent text-white border-2 border-white font-semibold rounded-md hover:bg-white hover:text-primary hover:-translate-y-0.5 transition-all duration-200">
            Jam Operasional
          </a>
        </motion.div>
